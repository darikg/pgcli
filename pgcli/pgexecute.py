...
ForeignKey = namedtuple('ForeignKey', ['parentschema', 'childschema', 'parenttable', 'childtable', 'parentcolumns', 'childcolumns'])
...
class PGExecute(object):
    ...
    def foreignkeys(self):
        ...
        with self.conn.cursor() as cur:
            query = '''
                SELECT s_p.nspname AS parentschema, s_c.nspname AS childschema,
                       t_p.relname AS parenttable, t_c.relname AS childtable,
                       (
                        select
